    ...
    return (
        <div className="flex items-center justify-center mb-10">
            <div className="rounded-lg w-full justify-center max-w-sm space-y-2">
                ...
                <button style={{ backgroundColor: 'var(--buttons)' }} className="w-50 p-2 shadow-md rounded-md cursor-pointer transition" onClick={(e) => handleFollow(e)}>{subscribe ? "Ne plus suivre" : "Suivre"}</button>
            </div>
        </div>
    );
}