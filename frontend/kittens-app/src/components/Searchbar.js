    ...
    return (
        <div className="flex items-center justify-center">
            <div className="relative w-full sm:w-[calc(50%-0.5rem)] p-2 m-4 box-border flex flex-col justify-between space-y-2">
                ...
                <input type="text" id="searchbar" value={searchText} onChange={handleChange} className="bg-white mt-1 pl-10 block w-full rounded-xl border border-gray-300 p-2 focus:border-blue-500 focus:outline-none" placeholder="Rechercher un utilisateur"/>
            </div>
        </div>
    );
}